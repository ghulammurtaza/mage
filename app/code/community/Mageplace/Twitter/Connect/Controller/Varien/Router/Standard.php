...
class Mageplace_Twitter_Connect_Controller_Varien_Router_Standard extends Mage_Core_Controller_Varien_Router_Standard
{
	public function match(Zend_Controller_Request_Http $request)
	{
		...
		$module = $path[0];
		$realModule = 'Mageplace_Twitter_Connect';
		$controller = $path[1];
