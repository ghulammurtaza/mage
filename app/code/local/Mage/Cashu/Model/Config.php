 ...
 */
/**
 * Cashu Configuration Model
 *
 * @category   Mage
 * @package    Mage_Cashu
 * @name       Mage_Cashu_Model_Config
 * @author     Magento Core Team <core@magentocommerce.com>
 */

class Mage_Cashu_Model_Config extends Varien_Object
{
    /**
     *  Return config var
     *
    ...
    {
        if (!$this->hasData($key)) {
            $value = Mage::getStoreConfig('payment/cashu_standard/'.$key);
 ...
 /**
    ...
    /**
     *  Return Store description sent to Cashu
     *
