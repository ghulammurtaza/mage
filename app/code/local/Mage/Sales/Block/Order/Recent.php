...
class Mage_Sales_Block_Order_Recent extends Mage_Core_Block_Template
{
    ...
    {
        $encryptedId = base64_encode($order->getId());
        return $this->getUrl('sales/order/view', array('order_id' => $encryptedId));
    ...
    {
        $encryptedId = base64_encode($order->getId());
        return $this->getUrl('sales/order/reorder', array('order_id' => $encryptedId));
